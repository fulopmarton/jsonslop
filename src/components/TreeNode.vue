<template>
    <div :class="[
        ...
        <div class="flex-1 min-w-0">
            ...
            ]" @click.stop="copyToClipboard(formatValue(node.value))"
...
const isChildExpanded = (child: JSONNode): boolean => {
    // This will be determined by parent component based on store state
    return false
}
...
const isChildHighlighted = (child: JSONNode): boolean => {
    // This will be determined by parent component based on search results
    return false
}
